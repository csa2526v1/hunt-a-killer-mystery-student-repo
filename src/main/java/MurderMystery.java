...
public class MurderMystery {
    ...
    public static final int randomQuestions = 4;
    // Number of code line questions to ask, 7 max
    public static final int fileQuestions = 3;
    ...
    private static boolean validloginID(String id) {
        String[] validIDs = {"mirah", "mirahtest", "mirahtest2", "mirahtest3", "mirahtest4", "mirahtest5", "prithvi", "tejus", "nitin", "oliver", "connor", "jack", "maddie", "devan", "gracie", "aryaan", "ethan", "naren", "nithya", "diya", "sampada", "navtan", "quin"};
     ...
     *
     * @param time time Time past 0, 5 mins per turn
     *
